...
*This is the narrative version of the essay. For the full interactive version with demos, see [The Universe Doesn't Troll Us — Interactive](/blog/pnp).*
...
*The full argument, interactive visualizations, and complete dialogue are available on the [interactive page](/blog/pnp). The formal paper is available in the [PNP repository](https://github.com/dcarnold/pnp).*
